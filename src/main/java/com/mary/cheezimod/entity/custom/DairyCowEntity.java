...
public class DairyCowEntity extends Animal implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public DairyCowEntity(EntityType<? extends Animal> p_27557_, Level p_27558_) {
...
//    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob ageableMob) {
        return ModEntityTypes.DAIRY_COW.get().create(level);
    }
    @Override
